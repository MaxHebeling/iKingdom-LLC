// ─────────────────────────────────────────────────────────────
// iKingdom — Country dial codes for the international phone input.
// Source: ITU E.164 assignments. Flag emoji derived from ISO-3166-1.
// ─────────────────────────────────────────────────────────────
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Saint Kitts & Nevis", iso2: "KN", dial: "+1" },
  { name: "Saint Lucia", iso2: "LC", dial: "+1" },
  { name: "Saint Vincent", iso2: "VC", dial: "+1" },
  { name: "Samoa", iso2: "WS", dial: "+685" },
  { name: "San Marino", iso2: "SM", dial: "+378" },
  { name: "São Tomé & Príncipe", iso2: "ST", dial: "+239" },
  ...
  { name: "Trinidad & Tobago", iso2: "TT", dial: "+1" },
...
export const COUNTRY_OPTIONS = COUNTRIES.map((c) => ({
  value: c.dial + "|" + c.iso2,
  label: `${flag(c.iso2)}  ${c.name} (${c.dial})`,
  short: `${flag(c.iso2)} ${c.dial}`,
}));

export const DEFAULT_COUNTRY = COUNTRY_OPTIONS[0]!; // México
