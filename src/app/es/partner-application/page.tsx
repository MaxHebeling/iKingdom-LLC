...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.ikingdom.org/es/partner-application",
    languages: {
  ...
  openGraph: {
    ...
    url: "https://www.ikingdom.org/es/partner-application",
    type: "website",
    locale: "es_ES",
...
export default function PartnerApplicationPageEs() {
  return (
    <main
    ...
    >
      ...
      <section className="max-w-3xl mx-auto px-6 md:px-10 pb-28">
        ...
        >
          <ApplicationClient lang="es" formKey="partner" />
        </div>
