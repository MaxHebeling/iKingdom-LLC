...
export const metadata: Metadata = {
  title: "Sitio web + Campus virtual · iKingdom",
...
const STEPS = [
  ...
  },
  {
    ...
    body: "Estructura académica, matrícula, clases, evaluaciones, certificados, pagos, roles y datos técnicos.",
    time: "≈ 25 minutos",
  },
];
    ...
    >
      <section className="max-w-4xl mx-auto px-6 md:px-10 pt-24 md:pt-36 pb-24 text-center">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-[18px] leading-[1.45]" style={{ color: "#6e6e73" }}>
          Para construir tu sitio web y tu campus virtual necesitamos conocer tu ministerio a fondo. Puedes completarlos
