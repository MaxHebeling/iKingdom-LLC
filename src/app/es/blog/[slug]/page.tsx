...
export async function generateMetadata({
  ...
  const url = `https://www.ikingdom.org/es/blog/${post.slug}`;
  const enUrl = `https://www.ikingdom.org/blog/${post.slug}`;
...
export default async function BlogPostPageES({
  ...
  const jsonLd = {
    ...
    mainEntityOfPage: `https://www.ikingdom.org/es/blog/${post.slug}`,
    image: post.image
  ...
  return (
    <>
      ...
      <link
        rel="alternate"
        hrefLang="es"
        href={`https://www.ikingdom.org/es/blog/${post.slug}`}
      />
