const COPY = {
  en: {
    ...
    rights: (year: number) => `© ${year} iKingdom. All rights reserved.`,
    established: "Established · The world's first AI operations firm",
  },
  es: {
    tagline:
    ...
    rights: (year: number) => `© ${year} iKingdom. Todos los derechos reservados.`,
    established: "Establecido · La primera firma de operaciones de IA del mundo",
  },
} as const;
